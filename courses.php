...
<head>
    <meta charset="utf-8">
    <title>Courses | Compass National Education</title>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center website-color px-3">Courses</h6>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <a href="course_detail.php?course_id=<?php echo $row_Recordset2['course_id']; ?>">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid"
                                    src="admin/assets/images/course/<?php echo $row_Recordset2['image']; ?>" alt="">
                            </div>
                            <div class="text-center p-4 pb-2">
                                <h5 class="mb-4"><?php echo $row_Recordset2['course_name']; ?></h5>
                            </div>
                        </a>
                    </div>
                </div>
