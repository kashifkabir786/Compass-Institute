...
<head>
    ...
    <title>Gallery Image | Compass National Institute</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Gallery Image </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body"> <a href="add_gallery.php">
                                        <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw"><i
                                                class="mdi mdi-card menu-icon"></i> &nbsp;ADD GALLERY IMAGE</button>
                                    </a>
                    ...
                    <div class="row">
                      ...
                      if ( $totalRows_Recordset2 > 0 ) {
                          do {
                              ?>
                                                <tr>
                                                    <td><a href="assets/images/gallery/<?php echo $row_Recordset2['image'] ?>"
                                                            target="_blank"><img
                                                                src="assets/images/gallery/<?php echo $row_Recordset2['image'] ?>"></a>
                                                    </td>

                                                    <td> <a
                                                            href="delete_gallery.php?gallery_id=<?php echo $row_Recordset2['gallery_id']; ?>"><i
