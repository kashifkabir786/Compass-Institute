...
<head>
    ...
    <title>Testimonial | Compass National Institute</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Testimonial </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body"> <a href="add_testimonial.php">
                                        <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw"><i
                                                class="mdi mdi-card menu-icon"></i> &nbsp;ADD TESTIMONIAL</button>
                                    </a>
                          ...
                          do {
                              ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row_Recordset2['proffession']; ?></td>
                                                    <td><a href="assets/images/testimonial/<?php echo $row_Recordset2['image'] ?>"
                                                            target="_blank"><img
                                                                src="assets/images/testimonial/<?php echo $row_Recordset2['image'] ?>"></a>
                                                    </td>
                                                    <td><a
                                                            href="add_testimonial.php?testimonial_id=<?php echo $row_Recordset2['testimonial_id']; ?>"><i
                                                                class="mdi mdi-pencil menu-icon"></i></a> &nbsp; <a
                                                            href="delete_testimonial.php?testimonial_id=<?php echo $row_Recordset2['testimonial_id']; ?>"><i
