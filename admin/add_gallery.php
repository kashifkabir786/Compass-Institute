...
if ( isset( $_GET[ 'gallery_id' ] ) ) {
    ...
    $query_Recordset2 = "SELECT * FROM gallery WHERE gallery_id = '$gallery_id'";
...
if ( isset( $_GET[ 'success' ] ) && $_GET[ 'success' ] == "Added" ) {
    $query_Recordset2 = "SELECT * FROM gallery ORDER BY gallery_id DESC LIMIT 1";
    $Recordset2 = mysqli_query( $compass_institute, $query_Recordset2 )or die( mysqli_error( $compass_institute ) );
    $row_Recordset2 = mysqli_fetch_assoc( $Recordset2 );
    $totalRows_Recordset2 = mysqli_num_rows( $Recordset2 );
    $gallery_id = $row_Recordset2[ 'gallery_id' ];
    $flag = true;
}
...
<head>
    ...
    <title>Add Gallery Image | Compass National Institute</title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Add Gallery Image </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 mb-1"> <a href="gallery.php">
                                                <button type="button"
        ...
        if ( isset( $_GET[ 'success' ] ) ) {
            ...
            echo '<div class="alert alert-success">Gallery ' . $_GET[ 'success' ] . ' Successfully</div>';
            echo '</div>';
        }
        ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6"> <img
                                                src="assets/images/gallery/<?php echo $row_Recordset2['image'] ?>"
                                            ...
                                            <form action="<?php echo $editFormAction; ?>" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="gallery_id"
                                                        value="<?php echo $row_Recordset2['gallery_id'] ?>" />
