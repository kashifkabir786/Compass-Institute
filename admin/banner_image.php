...
<head>
    ...
    <title>Add Banner Image | Compass National Institute</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Banner Image </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body"> <a href="add_banner_image.php">
                                        <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw"><i
                                                class="mdi mdi-card menu-icon"></i> &nbsp;ADD BANNER IMAGE</button>
                                    </a>
                    ...
                    <div class="row">
                      ...
                      if ( $totalRows_Recordset2 > 0 ) {
                          do {
                              ?>
                                                <tr>
                                                    <td><a href="assets/images/banner/<?php echo $row_Recordset2['banner_image'] ?>"
                                                            target="_blank"><img
                                                                src="assets/images/banner/<?php echo $row_Recordset2['banner_image'] ?>"></a>
                                                    </td>

                                                    <td> <a
                                                            href="delete_banner_image.php?banner_id=<?php echo $row_Recordset2['banner_id']; ?>"><i
