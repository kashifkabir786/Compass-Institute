...
$query_Recordset2 = "SELECT * FROM `student`";
...
<head>
    ...
    <title>Student | Compass National Institute</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Student </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body"> <a href="add_student.php">
                                        <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw"><i
                                                class="mdi mdi-card menu-icon"></i> &nbsp;ADD Student</button>
                                    </a>
                    ...
                    <div class="row">
                      ...
                      if ( $totalRows_Recordset2 > 0 ) {
                          do {
                              ?>
                                                <tr>
                                                    <td><?php echo $row_Recordset2['father_name']; ?></td>
                                                    <td><?php echo $row_Recordset2['fullname']; ?></td>
                                                    <td><?php echo $row_Recordset2['roll']; ?></td>
                                                    <td><?php echo $row_Recordset2['session']; ?></td>
                                                    <td><?php echo $row_Recordset2['grade']; ?></td>
                                                    <td><?php echo $row_Recordset2['grade']; ?></td>
                                                    <td><a
                                                            href="add_student.php?student_id=<?php echo $row_Recordset2['student_id']; ?>"><i
                                                                class="mdi mdi-pencil menu-icon"></i></a> &nbsp; <a
                                                            href="delete_student.php?student_id=<?php echo $row_Recordset2['student_id']; ?>"><i
