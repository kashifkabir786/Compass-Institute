...
<head>
    ...
    <title>Notice | Compass National Institute</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Notice </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body"> <a href="add_notice.php">
                                        <button type="button" class="btn btn-gradient-primary btn-rounded btn-fw"><i
                                                class="mdi mdi-card menu-icon"></i> &nbsp;ADD NOTICE</button>
                                    </a>
                    ...
                    <div class="row">
                      ...
                      if ( $totalRows_Recordset2 > 0 ) {
                          do {
                              ?>
                                                <tr>
                                                    <td><?php echo $row_Recordset2['notice']; ?></td>
                                                    </td>
                                                    <td><a
                                                            href="add_notice.php?notice_id=<?php echo $row_Recordset2['notice_id']; ?>"><i
                                                                class="mdi mdi-pencil menu-icon"></i></a> &nbsp; <a
                                                            href="delete_notice.php?notice_id=<?php echo $row_Recordset2['notice_id']; ?>"><i
