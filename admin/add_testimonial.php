...
if ( ( isset( $_POST[ "MM_insert" ] ) ) && ( $_POST[ "MM_insert" ] == "form1" ) ) {
    ...
    if ( move_uploaded_file( $_FILES[ 'image' ][ 'tmp_name' ], $target ) ) {
        ...
        $insertSQL = sprintf( "INSERT INTO `testimonial`(`name`, `proffession`, `content`, `image`) VALUES (%s, %s, %s, %s)",
            GetSQLValueString( $_POST[ 'name' ], "text" ),
            GetSQLValueString( $_POST[ 'proffession' ], "text" ),
...
if ( ( isset( $_POST[ "MM_update" ] ) ) && ( $_POST[ "MM_update" ] == "form1" ) ) {
    ...
    $updateSQL = sprintf( "UPDATE `testimonial` SET `name` = %s, `proffession` = %s, `content` = %s WHERE testimonial_id = %s",
            GetSQLValueString( $_POST[ 'name' ], "text" ),
            GetSQLValueString( $_POST[ 'proffession' ], "text" ),
            GetSQLValueString( $_POST[ 'content' ], "text" ),
...
<head>
    ...
    <title>Add Testimonial | Compass National Institute</title>
    <!-- plugins:css -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="proffession" class="form-control"
                                                        placeholder="Proffession"
                                                        value="<?php if($flag) echo $row_Recordset2['proffession'] ?>"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="content" class="form-control"
                                                        placeholder="Content"
                                                        value="<?php if($flag) echo $row_Recordset2['content'] ?>"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
